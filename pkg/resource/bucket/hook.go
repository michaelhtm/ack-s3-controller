...
func (rm *resourceManager) addPutFieldsToSpec(
	...
	} else if ko.Spec.Accelerate != nil {
	...
	} else if ko.Spec.Encryption != nil {
	...
	} else if len(ko.Spec.IntelligentTiering) > 0 {
	...
	} else if ko.Spec.Notification != nil {
	...
	} else if ko.Spec.OwnershipControls != nil {
	...
	} else if ko.Spec.PublicAccessBlock != nil {
	...
	} else if ko.Spec.Replication != nil {
	...
	} else if ko.Spec.RequestPayment != nil {
	...
	} else if ko.Spec.Versioning != nil {
