...
const (
	BucketCannedACL_authenticated_read BucketCannedACL = "authenticated_read"
	BucketCannedACL_private            BucketCannedACL = "private"
	BucketCannedACL_public_read        BucketCannedACL = "public_read"
	BucketCannedACL_public_read_write  BucketCannedACL = "public_read_write"
)
...
const (
	...
	BucketLocationConstraint_af_south_1     BucketLocationConstraint = "af_south_1"
	BucketLocationConstraint_ap_east_1      BucketLocationConstraint = "ap_east_1"
	BucketLocationConstraint_ap_northeast_1 BucketLocationConstraint = "ap_northeast_1"
	BucketLocationConstraint_ap_northeast_2 BucketLocationConstraint = "ap_northeast_2"
	BucketLocationConstraint_ap_northeast_3 BucketLocationConstraint = "ap_northeast_3"
	BucketLocationConstraint_ap_south_1     BucketLocationConstraint = "ap_south_1"
	BucketLocationConstraint_ap_south_2     BucketLocationConstraint = "ap_south_2"
	BucketLocationConstraint_ap_southeast_1 BucketLocationConstraint = "ap_southeast_1"
	BucketLocationConstraint_ap_southeast_2 BucketLocationConstraint = "ap_southeast_2"
	BucketLocationConstraint_ap_southeast_3 BucketLocationConstraint = "ap_southeast_3"
	BucketLocationConstraint_ca_central_1   BucketLocationConstraint = "ca_central_1"
	BucketLocationConstraint_cn_north_1     BucketLocationConstraint = "cn_north_1"
	BucketLocationConstraint_cn_northwest_1 BucketLocationConstraint = "cn_northwest_1"
	BucketLocationConstraint_eu_central_1   BucketLocationConstraint = "eu_central_1"
	BucketLocationConstraint_eu_north_1     BucketLocationConstraint = "eu_north_1"
	BucketLocationConstraint_eu_south_1     BucketLocationConstraint = "eu_south_1"
	BucketLocationConstraint_eu_south_2     BucketLocationConstraint = "eu_south_2"
	BucketLocationConstraint_eu_west_1      BucketLocationConstraint = "eu_west_1"
	BucketLocationConstraint_eu_west_2      BucketLocationConstraint = "eu_west_2"
	BucketLocationConstraint_eu_west_3      BucketLocationConstraint = "eu_west_3"
	BucketLocationConstraint_me_south_1     BucketLocationConstraint = "me_south_1"
	BucketLocationConstraint_sa_east_1      BucketLocationConstraint = "sa_east_1"
	BucketLocationConstraint_us_east_2      BucketLocationConstraint = "us_east_2"
	BucketLocationConstraint_us_gov_east_1  BucketLocationConstraint = "us_gov_east_1"
	BucketLocationConstraint_us_gov_west_1  BucketLocationConstraint = "us_gov_west_1"
	BucketLocationConstraint_us_west_1      BucketLocationConstraint = "us_west_1"
	BucketLocationConstraint_us_west_2      BucketLocationConstraint = "us_west_2"
)
...
const (
	Event_s3_IntelligentTiering                            Event = "s3_IntelligentTiering"
	Event_s3_LifecycleExpiration_                          Event = "s3_LifecycleExpiration_"
	Event_s3_LifecycleExpiration_Delete                    Event = "s3_LifecycleExpiration_Delete"
	Event_s3_LifecycleExpiration_DeleteMarkerCreated       Event = "s3_LifecycleExpiration_DeleteMarkerCreated"
	Event_s3_LifecycleTransition                           Event = "s3_LifecycleTransition"
	Event_s3_ObjectAcl_Put                                 Event = "s3_ObjectAcl_Put"
	Event_s3_ObjectCreated_                                Event = "s3_ObjectCreated_"
	Event_s3_ObjectCreated_CompleteMultipartUpload         Event = "s3_ObjectCreated_CompleteMultipartUpload"
	Event_s3_ObjectCreated_Copy                            Event = "s3_ObjectCreated_Copy"
	Event_s3_ObjectCreated_Post                            Event = "s3_ObjectCreated_Post"
	Event_s3_ObjectCreated_Put                             Event = "s3_ObjectCreated_Put"
	Event_s3_ObjectRemoved_                                Event = "s3_ObjectRemoved_"
	Event_s3_ObjectRemoved_Delete                          Event = "s3_ObjectRemoved_Delete"
	Event_s3_ObjectRemoved_DeleteMarkerCreated             Event = "s3_ObjectRemoved_DeleteMarkerCreated"
	Event_s3_ObjectRestore_                                Event = "s3_ObjectRestore_"
	Event_s3_ObjectRestore_Completed                       Event = "s3_ObjectRestore_Completed"
	Event_s3_ObjectRestore_Delete                          Event = "s3_ObjectRestore_Delete"
	Event_s3_ObjectRestore_Post                            Event = "s3_ObjectRestore_Post"
	Event_s3_ObjectTagging_                                Event = "s3_ObjectTagging_"
	Event_s3_ObjectTagging_Delete                          Event = "s3_ObjectTagging_Delete"
	Event_s3_ObjectTagging_Put                             Event = "s3_ObjectTagging_Put"
	Event_s3_ReducedRedundancyLostObject                   Event = "s3_ReducedRedundancyLostObject"
	Event_s3_Replication_                                  Event = "s3_Replication_"
	Event_s3_Replication_OperationFailedReplication        Event = "s3_Replication_OperationFailedReplication"
	Event_s3_Replication_OperationMissedThreshold          Event = "s3_Replication_OperationMissedThreshold"
	Event_s3_Replication_OperationNotTracked               Event = "s3_Replication_OperationNotTracked"
	Event_s3_Replication_OperationReplicatedAfterThreshold Event = "s3_Replication_OperationReplicatedAfterThreshold"
)
...
const (
	...
	ObjectAttributes_OBJECT_PARTS  ObjectAttributes = "OBJECT_PARTS"
	ObjectAttributes_OBJECT_SIZE   ObjectAttributes = "OBJECT_SIZE"
	ObjectAttributes_STORAGE_CLASS ObjectAttributes = "STORAGE_CLASS"
)

type ObjectCannedACL string

const (
	ObjectCannedACL_authenticated_read        ObjectCannedACL = "authenticated_read"
	ObjectCannedACL_aws_exec_read             ObjectCannedACL = "aws_exec_read"
	ObjectCannedACL_bucket_owner_full_control ObjectCannedACL = "bucket_owner_full_control"
	ObjectCannedACL_bucket_owner_read         ObjectCannedACL = "bucket_owner_read"
	ObjectCannedACL_private                   ObjectCannedACL = "private"
	ObjectCannedACL_public_read               ObjectCannedACL = "public_read"
	ObjectCannedACL_public_read_write         ObjectCannedACL = "public_read_write"
)
...
const (
	OptionalObjectAttributes_RESTORE_STATUS OptionalObjectAttributes = "RESTORE_STATUS"
)
